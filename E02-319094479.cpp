...
int main(){
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//trianguloverde
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.75f, -0.46f, -4.0f));
		...
		//cuadradoverde1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.775f, -4.0f));
		...
		//cuadradoverde2
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.2f, -0.15f, -4.0f));
		model = glm::scale(model, glm::vec3(0.25f, 0.25f, 0.25f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshColorList[4]->RenderMeshColor();
		...
		//cuadradorojo
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, -0.4f, -7.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
