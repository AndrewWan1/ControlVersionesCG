...
int main()
{
	...
	CrearCono(15, 2.0f);//índice 3 en MeshList
	...
	*/
	...
	glm::mat4 padre1(1.0);//Cabina
	glm::mat4 padre2(1.0);//Base
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = modelaux;
		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion3()), glm::vec3(0.5f, 0.5f, 1.0f));
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.5f, 0.5f, 0.5f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.4f, 0.3f, 0.0f);
		...
		//Articulacion 5
		model = padre2;
		model = glm::translate(model, glm::vec3(2.5f, -1.25f, 1.25f));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.075f, 1.0f, 0.075f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.075f, 1.2f, 0.075f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.1f, 0.1f, 0.1f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(0.075f, 0.4f, 0.075f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
