...
int main()
{
	...
	camera = Camera(glm::vec3(0.0f, 0.5f, 7.0f), glm::vec3(0.0f, 1.0f, 0.0f), -60.0f, 0.0f, 0.3f, 0.1f);

	Goddard_Cuerpo = Model();
	Goddard_Cuerpo.LoadModel("Models/Cuerpo.obj");
	Goddard_PataDD = Model();
	Goddard_PataDD.LoadModel("Models/PataDD.obj");
	Goddard_PataDI = Model();
	Goddard_PataDI.LoadModel("Models/PataDI.obj");
	Goddard_PataTD = Model();
	Goddard_PataTD.LoadModel("Models/PataTD.obj");
	Goddard_PataTI = Model();
	Goddard_PataTI.LoadModel("Models/PataTI.obj");
	...
	Carro_RuedaDD = Model();
	Carro_RuedaDD.LoadModel("Models/RuedaDD.obj");
	Carro_RuedaDI = Model();
	Carro_RuedaDI.LoadModel("Models/RuedaDI.obj");
	Carro_RuedaTD = Model();
	Carro_RuedaTD.LoadModel("Models/RuedaTD.obj");
	Carro_RuedaTI = Model();
	Carro_RuedaTI.LoadModel("Models/RuedaTI.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//model = glm::translate(model, glm::vec3(1.0f, 0.15f, 0.7f));
		...
		//model = modelaux;
		//model = glm::translate(model, glm::vec3(-0.4f, -0.65f, 0.7f));
		...
		//Carro
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 2.65f, -15.0f));
